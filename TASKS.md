...
- [x] Validate the editor in a real Home Assistant card dialog through the
      2.18.0-alpha.1 HACS prerelease.
- [ ] Complete an additional narrow-mobile editor layout pass.
