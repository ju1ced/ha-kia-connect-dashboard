...
PATTERN = re.compile(r"\b(?:sensor|binary_sensor|switch|cover|lock|climate|calendar|device_tracker|button|number|select|input_boolean|input_datetime|input_number|input_select)\.[a-zA-Z0-9_]+\b")
