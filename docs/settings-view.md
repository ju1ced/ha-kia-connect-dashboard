...
- `dashboard/cards/settings-hero.yaml` owns page context and administration
  scope.
- `dashboard/cards/settings-entity-mapping.yaml` owns mapping guidance and
  future mapping health checks.
...
- Bind refresh actions to the mapped controls once the shared action pattern is
  documented.
- Add mapping health and missing-entity status after reusable diagnostic cards
  exist.
