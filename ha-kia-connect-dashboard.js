class KiaDashboardCard extends HTMLElement {
  ...
  _renderSettingsTab() {
    ...
    const climateState = this._state("climate", "Not configured");
    const chargingState = this._state("charging_state", "Not configured");
